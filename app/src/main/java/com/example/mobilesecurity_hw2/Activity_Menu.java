package com.example.mobilesecurity_hw2;
...
public class Activity_Menu extends AppCompatActivity {
        ...
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (tempID.length() < 8) {
                    ...
                    Toast.makeText(Activity_Menu.this, "The ID must be exactly 9 digits long", Toast.LENGTH_SHORT).show();
    ...
    public void makeServerCall() {
        new Thread(() -> {
            ...
            Log.d("pttt", Activity_Menu.getJSON(Activity_Menu.this.getString(R.string.url)));
            Log.d("pttt", data);
            if (data != null) {
